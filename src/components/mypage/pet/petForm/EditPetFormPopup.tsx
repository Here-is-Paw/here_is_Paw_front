...
import {
    ...
    AlertDialogCancel,
    AlertDialogPortal,
    AlertDialogOverlay, AlertDialogTitle, AlertDialogDescription, AlertDialogHeader,
                ...
                <AlertDialogContent className="max-w-[500px] p-6 rounded-xl bg-white shadow-lg">
                    ...
                    <Card className="border-none shadow-none">
                        ...
                        <CardContent className="px-0">
                            <PetForm form={form} onSubmit={handleSubmit} onClose={handleClose} isEditing={true} />
                        </CardContent>
                    </Card>
                </AlertDialogContent>
            </AlertDialogPortal>
