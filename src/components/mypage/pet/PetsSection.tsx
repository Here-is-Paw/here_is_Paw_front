...
interface PetsSectionProps {
    ...
    onMissingReportSuccess?: () => void; // 이 부분 추가
}
        ...
        <>
                            ...
                            {userPets.map((pet, index) => (
                                ...
                                >
                                    <div className="flex items-center gap-4 break-all">
                                        <div
                                            className="bg-green-100 h-12 w-12 rounded-full flex items-center justify-center">
            ...
            {petToReport && (
                <MissingFormPopup
                    ...
                    onSuccess={handleMissingFormSuccess} // 이미 이 부분은 제대로 설정되어 있음
                    pets={petToReport}
                />
            )}
        </>
