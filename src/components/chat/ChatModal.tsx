                                ...
                                return (
                                    <div key={msg.id || index}
                                        ...
                                        <div
                                            ...
                                            {msg.sender !== 'me' && (
                                                <span
                                                    className="text-xs text-gray-600 mb-1">{otherUserInfo.nickname}</span>
                                            )}
                                            <div className="flex flex-row items-end">
                                                {msg.sender === 'me' && (
                                                    <span
                                                        className="text-[10px] text-gray-400 mr-2 shrink-0">{msg.time}</span>
                                                )}
                                                <div
                                                ...
                                                {msg.sender !== 'me' && (
                                                    <span
                                                        className="text-[10px] text-gray-400 ml-2 shrink-0">{msg.time}</span>
                                                )}
                                            </div>
                                        </div>
                                    </div>
