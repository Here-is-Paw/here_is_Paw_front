...
export function NavBarMobile({ buttonStates, toggleButton }: NavBarMobileProps) {
    ...
    return (
        <>
            ...
            <nav className="fixed top-[30px] left-0 z-20 w-full">
                <div className="px-4 py-2">
                    <div className="flex justify-between items-center bg-white rounded-full shadow-lg px-3 py-1">
                        <div>
                            <Button
                                variant="outline"
                                size="icon"
                            ...
                            {isResistModalOpen && (
                                <div
                                    className="absolute top-[45px] left-[10px] bg-white rounded-2xl w-[200px] overflow-hidden z-50">
            ...
            {/* FilterButton 배치 - 위치도 함께 조정 */}
            <div className="fixed top-[95px] right-8 z-[10]">
                <FilterButton
